...
const MONGO_URL = "mongodb+srv://Sole:Sole@cluster0.mcyln.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.use(session({
    ...
    secret: 'your-secret-key', // 🔒 Clave secreta de sesiones
    resave: true,
